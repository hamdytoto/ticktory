        ...
        <div className="relative">
          ...
          {isProfileOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-lg py-2 border border-gray-100">
              <button onClick={() => setActivePage("profile")} className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                {t("profile")}
              </button>
              <Link to="/settings" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                {t("settings")}
              </Link>
              <Link to="/auth/login" className="block px-4 py-2 text-red-600 hover:bg-gray-100">
                {t("logout")}
              </Link>
            </div>
          )}
