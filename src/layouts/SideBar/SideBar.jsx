    ...
    return (
        <>
            ...
            {isMobile && (
                ...
                >
                    {isMobileOpen ? <CloseIcon fontSize="medium" /> : <MenuIcon fontSize="medium" />}
                </button>
            )}
                            ...
                            {menuConfig[getUserRole(user.type)]?.map((item) => (
                                <li key={item.id} className="mt-5">
                                    <button
                                        ...
                                        className={`flex w-full items-center p-3.5 rounded-lg transition ${activePage === item.id ? "bg-[#051754] text-white" : "hover:bg-[#051754]"
                                            }`}
                                    >
