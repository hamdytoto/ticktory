...
const TechnicianActions = ({
    ...
    return (
        <>
            <h1 className="text-4xl font-bold text-gray-800">{t("technician.actions.title", "Add Technicians")}</h1>
            <div className="p-0 mb-6 mt-6 flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center rounded-xl bg-gray-50 shadow-md overflow-hidden flex-1 max-w-md p-3">
                    ...
                    <input
                        type="text"
                        placeholder={t("technician.actions.searchPlaceholder", "Search Technicians")}
                        value={search}
                ...
                <div className="flex flex-col sm:flex-row w-full sm:w-auto items-center gap-4">
                    ...
                    >
                        <FaPlus className="w-4 h-4" /> {t("technician.actions.newTechnician", "New Technician")}
                    </button>
                    <select
