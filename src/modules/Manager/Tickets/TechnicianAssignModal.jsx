...
import { useGetTechniciansQuery } from "../../../redux/feature/selectMenu/select.apislice.js";

const TechnicianAssignModal = ({ isOpen, onClose, onSubmit, ticket }) => {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                value={maxMinutes}
                onChange={(e) =>
                  setMaxMinutes(Math.max(1, parseInt(e.target.value) || 1))
                }
                className="w-full border px-3 py-2 rounded focus:ring-2 focus:ring-blue-500 outline-none"
