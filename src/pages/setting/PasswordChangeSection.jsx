        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6 transition-all hover:shadow-lg">
            ...
            <form onSubmit={handlePasswordChange} className="space-y-6">
                <PasswordInput
                    ...
                    setShowPassword={(value) => handlePasswordVisibilityChange('showCurrentPassword', value)}
                ...
                <PasswordInput
                    ...
                    setShowPassword={(value) => handlePasswordVisibilityChange('showNewPassword', value)}
                    iconPositionClass={iconPositionClass}
                ...
                <PasswordInput
                    ...
                    setShowPassword={(value) => handlePasswordVisibilityChange('showConfirmPassword', value)}
                    iconPositionClass={iconPositionClass}
